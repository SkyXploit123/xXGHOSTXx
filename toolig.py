...
vv1ck =(B+"""
        _____           _     ___           _
|_   _|__   ___ | |___|_ _|_ __  ___| |_ _ __ __ _  __ _ _ __ __ _ _ __ ___
  | |/ _ \ / _ \| / __|| || '_ \/ __| __| '__/ _` |/ _` | '__/ _` | '_ ` _ \
  | | (_) | (_) | \__ \| || | | \__ \ |_| | | (_| | (_| | | | (_| | | | | | |
  |_|\___/ \___/|_|___/___|_| |_|___/\__|_|  \__,_|\__, |_|  \__,_|_| |_| |_|
                                                   |___/
        By : SkyXploits
...
""")
print(vv1ck)
joker = input(Z+'  [=] Enter Number You Choice : '+X)
print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
time.sleep(1)
user = input("\nEnter username : ")
pess = input(Z+"Enter password : ")
def deletSEVE():
	def poSF():
		global iid , sis
	...
	def infoSEV():
		...
		while True:
			...
			try:
				...
				print('Follow me |telegram|  u_zzf ')
				exit()
	infoSEV()
def chatMS():
	def aco():
