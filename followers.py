...
╚═╗║ ║║║║ ║ ║╠╩╗  ║║ ╦
╚═╝╚═╝╝╚╝ ╩ ╩╩ ╩  ╩╚═╝
( di buat oleh [bold green]SkyXploits [bold white]) ''','color(8)')
...
def menu():
    Terminal() ; banner()
    panel('''[bold white][[bold yellow]1[bold white]] suntik followers ([bold green]indofull[bold white])
[bold white][[bold yellow]2[bold white]] suntik followers ([bold green]rendom[bold white])
[bold white][[bold yellow]3[bold white]] suntik like instagram ([bold green]indofull[bold white])
[bold white][[bold yellow]4[bold white]] suntik like instagram ([bold green]random[bold white])
