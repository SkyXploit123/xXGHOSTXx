#TINGGAL PAKE SUSAH AMAT SIH ASW

from os import path

import os,base64,zlib,pip,urllib

os.system('xdg-open https://youtube.com/@Keselektai')
...
try:
        ...
        os.system('python facebookclone.py')
...
for agent in range(10000):
        ...
        aa='Mozilla/5.0 (Linux; Android 11; SM-A105F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36;'
...
def login():
        ...
        try:
                ...
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 11; SM-A105F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Mobile Safari/537.36; Redmi 4A Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.92 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://youtube.com/{wx}');menu()

                        elif xd in ['7','07']:

                                os.system('xdg-open https://www.facebook.com/PRINCE.baralbrl.1');menu()
                        ...
                        url_wa = "https://www.facebook.com/PRINCE.PRINCE.1999999999999999"

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi PRINCE Sir, I Need To Buy Your Paid PRINCE PRO Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
