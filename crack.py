...
def banner():
	...
	prints(Panel(f'''{O2}                     " PREMIUM | Shishigami-X"{color_rich}
_____ _____________  ____________________ {H2}•{P2} Author  : SkyXploits {color_rich}
__  // /__  /___   |/  /__  __ )__  ____/ {H2}•{P2} Youtube: @Keselektai {color_rich}
_  // /__  / __  /|_/ /__  __  |_  /_     {H2}•{P2} Status  : {H2}Working{color_rich}
/__  __/  /___  /  / / _  /_/ /_  __/     {H2}•{P2} Whatsap : Kepo{color_rich}
  /_/  /_____/_/  /_/  /_____/ /_/        {H2}•{P2} Version : 1.2 ''',width=80,padding=(0,2),style=f"{color_table}"))
...
def cekAPI(cookie):
    ...
    try:
        ...
        prints(Panel(f"{P2}Akun Lu Cp Kontol, Login Pake Akun Lain.",width=80,style=f"{color_table}"));os.system('rm -rf data/.kukis.log rm -rf data/.username');exit()
...
def tlisensi():
    ...
    if lisen in ['']:
     ...
     tlisensi()
    if lisen in ['buy','Buy']:
     os.system('xdg-open https://wa.me/67573541212?text=Bang+beli+lisensi+IG+nya+dong');exit()
    loadinglisen()
...
def key():
	...
	try:ses = requests.Session();asu = ses.get("https://app.cryptolens.io/api/key/Activate?token===&ProductId=16754&Key=%s&Sign=True"%(key)).json()['licenseKey']['key'];open("data/lisensi.txt","w").write(key);prints(Panel(f"{P2}selamat lisensi kamu aktif, tolong gunakan tools ini dengan bijak",width=80,padding=(0,4),style=f"{color_table}"));time.sleep(4);login_kamu()
		...
		prints(Panel(f"{P2}lisensi kamu sudah kedaluwarsa silahkan beli lisensi ke admin",width=80,padding=(0,6),style=f"{color_table}"));os.system("rm -rf data/lisensi.txt");os.system("xdg-open https://wa.me/+67573541212?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram");time.sleep(2);exit()
...
def key():
	...
	try:ses = requests.Session();asu = ses.get("https://app.cryptolens.io/api/key/Activate?token=WyIyNTYzMTUwMyIsIjlJNmI2M3lTcGtackhEaCtyc2JTLzlBZWZLdzZLYTJyZU4rNDNBZk4iXQ==&ProductId=16754&Key=%s&Sign=True"%(key)).json()['licenseKey']['key'];open("data/lisensi.txt","w").write(key);prints(Panel(f"{P2}selamat lisensi kamu aktif, tolong gunakan tools ini dengan bijak",width=80,padding=(0,4),style=f"{color_table}"));time.sleep(4);login_kamu()
		...
		prints(Panel(f"{P2} lisensi yang anda masukan tidak terdaftar silahkan beli terlebih dahulu",width=80,padding=(0,1),style=f"{color_table}"));os.system("xdg-open https://wa.me/+67573541212?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram");time.sleep(2);exit()
...
def beli_bang():
    ...
    elif zxc in ["1","01"]:os.system("xdg-open https://wa.me/+67573541212?text=assalamualaikum+bang+mau+beli+lisensi+1+minggu");time.sleep(2);exit()
    elif zxc in ["2","02"]:os.system("xdg-open https://wa.me/+67573541212?text=assalamualaikum+bang+mau+beli+lisensi+1+bulan");time.sleep(2);exit()
    elif zxc in ["3","03"]:os.system("xdg-open https://wa.me/+67573541212?text=assalamualaikum+bang+mau+beli+lisensi+2+bulan");time.sleep(2);exit()
    elif zxc in ["4","04"]:os.system("xdg-open https://wa.me/+67573541212?text=assalamualaikum+bang+mau+beli+lisensi+permanen");time.sleep(2);exit()
